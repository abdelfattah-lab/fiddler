        ...
        for i_layer, layer in enumerate(self.model.layers):
            ...
            with torch.cuda.stream(self.compute_stream):
                ...
                for i_expert in range(len(experts)):
                    ...
                    # OPTIMIZATION: Direct tensor indexing (equivalent but faster than list conversion)
                    ...
                    if use_prefetched_buffer:
                        ...
                        # Count as hits only when using prefetched buffer
                        ...
                        # Count as misses when falling back to load_state_dict
                        batch_hit_count = top_2.shape[0]
                        self.cnt_expert_all += batch_hit_count
