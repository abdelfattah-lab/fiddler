#!/usr/bin/env python3
"""Profile Fiddler+Learned-Prefetch at batch size 16."""
...
def main():
    print("="*80)
    print("PROFILING: Fiddler+Learned-Prefetch (Batch Size = 16)")
    print("="*80)
    ...
    torch.cuda.nvtx.range_push("Fiddler+Learned_BS16_Generation")
